...
public class MecanumProportionalControl extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double xSpeed = gamepad1.left_stick_x * gamepad1.left_stick_x * gamepad1.left_stick_x;

            // Rotation from Right Joystick X-axis
            // Right stick X is -1.0 (left/counter-clockwise) to 1.0 (right/clockwise).
            // Set to negative because left and right was swapped.
            double rotationSpeed = -(gamepad1.right_stick_x * gamepad1.right_stick_x * gamepad1.right_stick_x);
            ...
            flywheel.setVelocity(6000*Math.pow(gamepad2.right_trigger,2));
